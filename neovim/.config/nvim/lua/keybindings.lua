...
map('n', '<leader>sb', [[<cmd>lua require('telescope.builtin').buffers()<CR>]],
    silent)
map('n', '<leader>sf',
    [[<cmd>lua require('telescope.builtin').find_files()<CR>]], silent)
map(
  'n',
  '<leader>sc',
...
map('n', '<leader>sh',
    [[<cmd>lua require('telescope.builtin').help_tags()<CR>]], silent)
-- map(
--   'n',
--   '<leader>st',
...
-- )
map('n', '<leader>ss',
    [[<cmd>lua require('telescope.builtin').grep_string()<cr>]], silent)
map('n', '<leader>sg',
    [[<cmd>lua require('telescope.builtin').live_grep()<cr>]], silent)
map('n', '<leader>se',
    [[<cmd>lua require('telescope.builtin').file_browser()<cr>]], silent)
